...
tree = {
    ...
    "node_025": ['node_004', 'node_009'],
    "node_017": ['node_025', 'node_006'],
    ...
    "node_015": ['node_021', 'node_000'],
    "node_003": ['node_001', 'node_030'],
    "node_001": ['node_028', 'node_007'],
    "node_028": ['node_008', 'custom_leaf_webservers'],
...
labels = {
    ...
    "leaf_yes": """YES""",
    "leaf_no": """NO""",
    "custom_leaf_webservers": """Use the webservers""",
}
